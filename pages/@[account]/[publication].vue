...
<template>
  ...
  <div class="max-w-3xl mx-auto space-y-2 overflow-y-auto p-1.5">
    <div class="bg-white dark:bg-gray-900 rounded-md p-2 space-y-2">
      ...
      <div class="text-sm whitespace-pre-wrap">
        <div class="select-auto">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
          Ipsum has been the
